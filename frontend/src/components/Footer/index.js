...
const Footer = () => {
    ...
    return (
        <div id='footer-container' className={`footer-animation-${footerGrow}`}>
            ...
            <div id='footer-bottom'>dsajkdasjdlas</div>
        </div>
    );
}
